    ...
    <div class="fly-panel fly-panel-user" pad20>
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        <ul class="layui-tab-title" id="LAY_mine">
          <li data-type="mine-jie" lay-id="index" class="layui-this">我发的文章</li>
          <li data-type="collection" data-url="/collection/find/" lay-id="collection">我收藏的文章</li>
        </ul>
            ...
            <ul class="mine-view jie-row" id="fabu">
              <script id="tpl-fabu" type="text/html">
                <li>
                  ...
                  <em>{{d.viewCount}}阅读 / {{d.commentCount}}评论</em>
                </li>
              </script>
